...
| 2   | Telekinetic Maneuver | MG/WL | 3   | Push, Pull, Trip,                                                                       | -     | Contested check to perform a combat maneuver (Manuevers are TBD). On success the target is moved or prone.                            | -        |
| 3.  | Healing Aura         | WL/CH | -   | Heal surface injuries of your team.                                                     | 2     | Spellcraft HP of healing per turn for all allies.                                                                                     | -        |
| 4.  | Aura of Speed        | CH/EN | -   | Your team moves faster                                                                  | 1     | +1 Speed to the team                                                                                                                  |          |
