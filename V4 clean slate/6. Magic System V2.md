...
| 7.  | Binding Chains        | EN/WL | 5   | 10m, Chains attack (against B/D/P ) the target keeping it in place                      |       | Target's speed is reduced to 1, Target can attempt to break the chain, which has d6 HP or .                                           |          |
