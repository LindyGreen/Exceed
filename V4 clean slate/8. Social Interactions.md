...
## Trading
Most items have an Ask price. The amount the seller is willing to part with the service or the item.Unless you as a GM want to hike up the prices rule of thumb is that sell price is from 25-75% and buying price is 75% to 125%. 
